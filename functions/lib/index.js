...
// ============================================================================
async function pollTripoTask(taskId, label) {
...
// ============================================================================
async function downloadAndStoreGlb(sourceUrl, storagePath, label) {
...
exports.process3DExtrusion = (0, tasks_1.onTaskDispatched)({
    ...
    try {
        ...
        const unriggedPermanentUrl = await downloadAndStoreGlb(unriggedUrl, `users/${userId}/agents/${agentId}/model_unrigged.glb`, "unrigged");
