        ...
        <div className="flex-1 flex items-stretch px-3 pb-3 gap-3 overflow-hidden">
          ...
          <div className="flex-1 relative rounded-xl overflow-hidden border border-[#d4af37]/10 bg-black/40">
            ...
            <div className="absolute inset-0">
              <Scene modelUrl={DEMO_MODELS[demoModelIdx].url} volumeRef={volumeRef} animationState={animationState} facingRotationY={DEMO_MODELS[demoModelIdx].facingRotationY} cameraPosition={[0, 0.3, 1.8]} cameraTarget={[0, 0, 0]} />
            </div>
